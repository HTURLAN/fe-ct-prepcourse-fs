...
function verificarPassword(objetoUsuario, password) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   var validez = objetoUsuario.password === password;
   return validez;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function () {
      valorDescuento = objetoProducto.precio * objetoProducto.porcentajeDeDescuento;
      precioFinal = objetoProducto.precio - valorDescuento
      return precioFinal;
      };
